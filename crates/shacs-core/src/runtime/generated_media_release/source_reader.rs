...
pub(in crate::runtime::generated_media_release) struct ConfinedSourceReader {
    root: File,
}

impl ConfinedSourceReader {
    pub(in crate::runtime::generated_media_release) fn from_root(root: File) -> Self {
        Self { root }
    }

    pub(in crate::runtime::generated_media_release) fn open(
        root: &Path,
    ...
    pub(in crate::runtime::generated_media_release) fn root_metadata(
        &self,
    ) -> Result<Metadata, Spec034ReleaseArtifactError> {
        self.root.metadata().map_err(Spec034ReleaseArtifactError::Io)
    }

    pub(in crate::runtime::generated_media_release) fn into_root(self) -> File {
        self.root
    }

    pub(in crate::runtime::generated_media_release) fn read(
        &self,
        locator: &str,
        max_bytes: u64,
    ...
    pub(in crate::runtime::generated_media_release) fn entry_names_with(
        &self,
    ...
    pub(in crate::runtime::generated_media_release) fn read_with(
        &self,
        locator: &str,
        max_bytes: u64,
    ...
    pub(in crate::runtime::generated_media_release) fn read_with_hooks(
        &self,
        locator: &str,
        max_bytes: u64,
        after_first_ancestor: impl FnOnce(),
    ...
    pub(in crate::runtime::generated_media_release) fn read_with_metadata_hooks(
        &self,
        locator: &str,
        max_bytes: u64,
        after_first_ancestor: impl FnOnce(),
