...
pub(in crate::runtime::spec034_release) struct SourceRootContext {
    root: PathBuf,
    live_handle: File,
...
impl SourceRootContext {
    #[cfg(test)]
    pub(in crate::runtime::spec034_release) fn resolve(
        root: &Path,
    ) -> Result<Self, Spec034ReleaseArtifactError> {
        Self::with_git(root, ResolvedTool::git()?, &[])
    }

    pub(in crate::runtime::spec034_release) fn resolve_release(
        root: &Path,
    ) -> Result<Self, Spec034ReleaseArtifactError> {
    ...
    pub(in crate::runtime::spec034_release) fn verify(
        &self,
    ...
    pub(in crate::runtime::spec034_release) fn verify_identity(
        &self,
    ) -> Result<(), Spec034ReleaseArtifactError> {
        self.seal.verify()?;
        self.git.verify()?;
    ...
    pub(in crate::runtime::spec034_release) fn root(&self) -> &Path {
        &self.root
    }

    pub(in crate::runtime::spec034_release) fn git(&self) -> &ResolvedTool {
        &self.git
    }

    pub(in crate::runtime::spec034_release) fn git_dir(&self) -> &Path {
        self.git_metadata.directory()
    }

    pub(in crate::runtime::spec034_release) fn binding_digest(&self) -> String {
