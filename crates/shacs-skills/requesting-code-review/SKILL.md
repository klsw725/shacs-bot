...
metadata.shacs.imported_from: software-development/requesting-code-review
---
...
Call `spawn` directly — it is NOT available inside exec or scripts.
...
- **spawn returns non-JSON** — retry once with stricter prompt, then treat as FAIL
