...
metadata.shacs.imported_from: mlops/inference/obliteratus
---
...
See `skills show(name="obliteratus", file_path="references/analysis-modules.md")` for the full reference.
...
Load templates for reproducible runs via `skills show`:
