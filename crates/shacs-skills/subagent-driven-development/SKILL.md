...
description: "Execute plans via spawn subagents (2-stage review)."
version: 1.1.0
...
metadata.shacs.imported_from: software-development/subagent-driven-development
---
...
Use `spawn` with complete context:
