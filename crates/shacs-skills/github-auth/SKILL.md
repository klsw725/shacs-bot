...
metadata.shacs.imported_from: github/github-auth
---
...
- Give it a title like "shacs-bot-<machine-name>"
...
elif [ -f ~/.shacs-bot/.env ] && grep -q "^GITHUB_TOKEN=" ~/.shacs-bot/.env; then
  export GITHUB_TOKEN=$(grep "^GITHUB_TOKEN=" ~/.shacs-bot/.env | head -1 | cut -d= -f2 | tr -d '\n\r')
  echo "AUTH_METHOD=curl"
