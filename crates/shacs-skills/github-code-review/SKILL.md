...
metadata.shacs.imported_from: github/github-code-review
---
...
# Now you can use read_file, grep / glob, run tests, etc.
...
```bash
source "<workspace>/builtin_skills/github-auth/scripts/gh-env.sh"
...
This gives you full access to `read_file`, `grep` / `glob`, and the ability to run tests.
