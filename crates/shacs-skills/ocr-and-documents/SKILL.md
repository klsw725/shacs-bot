...
metadata.shacs.imported_from: productivity/ocr-and-documents
---
...
For PPTX: use `python-pptx` directly when slide or speaker-note extraction is needed.
...
pymupdf handles these natively — use `exec` or inline Python:
...
- For slide decks: use `python-pptx` directly when PPTX slide or speaker-note extraction is needed
