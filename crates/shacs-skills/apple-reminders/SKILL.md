...
prerequisites:
  commands: [remindctl]
metadata.shacs.imported_from: apple/apple-reminders
---
...
- Scheduling agent alerts → use the cron tool instead
...
1. When user says "remind me", clarify: Apple Reminders (syncs to phone) vs agent cron alert
