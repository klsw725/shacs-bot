...
metadata.shacs.imported_from: creative/baoyu-infographic
---
...
Adapted from [baoyu-infographic](https://github.com/JimLiu/baoyu-skills) for shacs-bot's tool ecosystem.
...
Use the `ask_user` tool to confirm options with the user. Since `ask_user` handles one question at a time, ask the most important question first:
