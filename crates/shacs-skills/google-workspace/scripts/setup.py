#!/usr/bin/env python3
"""Google Workspace OAuth2 setup for shacs-bot.
...
def exchange_auth_code(code: str):
    ...
    print(f"Profile-scoped token location: {display_shacs_home()}/google_token.json")
