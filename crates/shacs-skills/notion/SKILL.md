...
metadata.shacs.imported_from: productivity/notion
---
...
Add those exports to your shell profile (or to `~/.shacs-bot/.env`) so every session inherits them.
