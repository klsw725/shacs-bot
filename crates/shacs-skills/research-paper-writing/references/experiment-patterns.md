...
| **Security scan blocks** | Commands blocked by security | Use `exec` instead of piped `terminal` commands |
| **Delegation failures** | `spawn` returns errors | Fall back to doing work directly |
