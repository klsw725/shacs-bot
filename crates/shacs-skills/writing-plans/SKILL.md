...
metadata.shacs.imported_from: software-development/writing-plans
---
...
> **For shacs-bot:** Use subagent-driven-development skill to implement this plan task-by-task.
...
Use shacs-bot tools to understand the project:

```python
# Understand project structure
grep / glob("*.py", target="files", path="src/")

# Look at similar features
grep / glob("similar_pattern", path="src/", file_glob="*.py")

# Check existing tests
grep / glob("*.py", target="files", path="tests/")
...
- Fresh `spawn` per task with full context
