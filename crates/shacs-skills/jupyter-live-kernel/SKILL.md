...
metadata.shacs.imported_from: data-science/jupyter-live-kernel
---
...
across executions. Use this instead of `exec` when you need to build up
...
| `exec` | One-shot scripts needing hermes tool access (web_search, file ops). Stateless. |
| `exec` | Shell commands, builds, installs, git, process management |
