...
metadata.shacs.imported_from: devops/webhook-subscriptions
disabled: true
...
- Subscriptions persist to `~/.shacs-bot/webhook_subscriptions.json`

## How It Works

1. `hermes webhook subscribe` writes to `~/.shacs-bot/webhook_subscriptions.json`
...
3. **Check gateway logs:** `grep webhook ~/.shacs-bot/logs/gateway.log | tail -20`
