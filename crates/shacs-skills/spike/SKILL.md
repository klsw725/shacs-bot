...
metadata.shacs.imported_from: software-development/spike
---
...
Use shacs-bot tools for the research step:
...
- `exec("pip show websockets | grep Version")` — check what's installed in the project's venv
...
```
exec("mkdir -p spikes/001-websocket-streaming")
write_file("spikes/001-websocket-streaming/README.md", "# 001: websocket-streaming\n\n...")
write_file("spikes/001-websocket-streaming/main.py", "...")
exec("cd spikes/001-websocket-streaming && python3 main.py")
# Observe output, iterate.
```

**Parallel comparison spikes (002a / 002b) — delegate.** When two approaches can run in parallel and both need real engineering (not 10-line prototypes), fan out with `spawn`:
