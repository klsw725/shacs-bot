...
- [x] **M1: AgentDefinition + AgentRegistry + 설정**
...
- [x] **M2: SubagentManager 통합 — 모델 라우팅 + 동시성**
...
- [x] **M3: ApprovalGate 일반화 + workspace 에이전트 승인**
