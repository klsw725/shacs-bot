...
| PRD | 대응 변경 | 설명 |
|---|---|---|
| [`progress-message-cleanup.md`](./prds/progress-message-cleanup.md) | 변경 1, 2 | send_progress 기본값 변경 + Discord typing 수정 |
| [`skill-hint.md`](./prds/skill-hint.md) | 변경 3 | 스킬 사용 감지 및 친화적 알림 |
