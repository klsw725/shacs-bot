...
> **SPEC**: [`docs/specs/2026-03-15-01-30-sisyphus-orchestration-spec.md`](../spec.md) — 변경 2, 변경 3
> **관련 PRD**: [`orchestration-prompt.md`](./orchestration-prompt.md) — 시스템 프롬프트에서 서브에이전트 역할을 안내하므로 함께 적용 시 효과 극대화
