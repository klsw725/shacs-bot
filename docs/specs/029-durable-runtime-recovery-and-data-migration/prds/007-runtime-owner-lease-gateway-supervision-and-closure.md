...
5. Scope evidence: 030 keeps unified redaction taxonomy ownership, 035 keeps physical runtime path/layout ownership. PRD007 consumes the current shared redaction and path-helper boundaries only.
