...
11. Documentation evidence: `README.md`, `docs/USAGE.md`, `docs/specs/029-durable-runtime-recovery-and-data-migration/SPEC.md`, PRD007, PRD008이 old baseline, Wave 1-8 durable redaction closure, 030 trusted-runtime disclosure, 035 credential-source 및 physical path/layout ownership을 분리한다.
