...
from shacs_bot.config.schema import EmailConfig
...
class EmailChannel(BaseChannel):
    ...
    async def send(self, msg: OutboundMessage) -> None:
        ...
        base_subject = self._last_subject_by_chat.get(to_addr, "shacs_bot reply")
        ...
        for media_path in msg.media or []:
            ...
            if not path.is_file():
                logger.warning("Email media file not found: {}", media_path)
                continue
    ...
    def _reply_subject(self, base_subject: str) -> str:
        subject = (base_subject or "").strip() or "shacs_bot reply"
