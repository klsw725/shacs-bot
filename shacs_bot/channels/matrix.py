...
from shacs_bot.config.schema import MatrixConfig
...
from shacs_bot.config.loader import get_data_dir
...
class MatrixChannel(BaseChannel):
    ...
    def __init__(self, config: MatrixConfig, bus, *, restrict_to_workspace: bool = False,
    ...
    async def _effective_media_limit_bytes(self) -> int:
        """min(local _config, server advertised) — 0 blocks all uploads."""
